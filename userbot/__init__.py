...
async def checking():
    ...
    checker = pybase64.b64decode("QHByb2plY3R5YW56eng=")
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk 𝐘𝐚𝐧𝐳𝐳𝐱-𝐔𝐬𝐞𝐫𝐛𝐨𝐭​, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @yanzzxsupport")
