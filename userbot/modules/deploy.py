...
async def _(event):
    ...
    animation_chars = [
        "Heroku Connecting To Latest Github Build (destraadryann/Yanzzx-userbot)",
        ...
        "INFO - Yanzzx-Userbot: Logged in as 557667062",
        "INFO - Yanzzx-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Rose-Userbot -",
        "INFO - ⚡ Yanzzx-Userbot ⚡ ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**",
    ]
