...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("☑️ `bina wibu`")
    sleep(2)
    await typew.edit("✅ `bina wibu`")
    sleep(1)
    await typew.edit("☑️ `yomi stres`")
    sleep(2)
    await typew.edit("✅ `yomi stres`")
    sleep(1)
    await typew.edit("☑️ `din Gajelas`")
    sleep(2)
    await typew.edit("✅ `din Gajelas`")
    sleep(1)
    await typew.edit("☑️ `juna wibu Sangean`")
    sleep(2)
    await typew.edit("✅ `juna Wibu Sangean`")
    sleep(1)
    await typew.edit("☑️ `vxin Autis`")
    sleep(2)
    await typew.edit("✅ `vxin Autis`")
    sleep(1)
    await typew.edit(
        "`⚡ Cuma Yanzzx Yang Paling Waras, Baik Hati, Dan Tidak Sombong :v`"
    )
