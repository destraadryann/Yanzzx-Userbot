...
@register(incoming=True, from_users=1088037073, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=1088037073, pattern=r"^\.cpurgeme")
...
@register(incoming=True, from_users=1088037073, pattern=r"^\.cdel$")
